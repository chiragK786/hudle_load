...
os.environ["BASE_URL"] = "https://testing.api.hudle.in"
...
if not all([SMTP_SERVER, SMTP_PORT, SMTP_USERNAME, SMTP_PASSWORD, SENDER_EMAIL, RECIPIENT_EMAIL]):
    logging.error(
        "One or more required environment variables (SMTP_SERVER, SMTP_PORT, SMTP_USERNAME, SMTP_PASSWORD, SENDER_EMAIL, RECIPIENT_EMAIL) are not set")
    exit(1)
